...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE recipes SET title = ?, recipe_type_id = ?, recipe_text = ? WHERE id = ? AND user_id = ?";
    $stmt = mysqli_prepare($link, $sql);
    mysqli_stmt_bind_param($stmt, "sisii", $title, $recipe_type_id, $recipe_text, $recipe_id, $_SESSION['user_id']);
